...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: beige;">
    <header style="background-color: #C4A484;padding: 10px;color: #fff;text-align: center;" >
        <div style="max-width: 960px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center;">
                <h1><a style="color:white" href="home.php">ShareSquare</a></h1>
            </div>
    ...
    <div style="max-width: 960px; margin: 0 auto; padding: 20px;">
        ...
        <!-- Add Post Form -->
        <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px; background-color: #fff;">
            <h2>Add Post</h2>
            <form action="addpost.php" method="post" id="add-post-form" enctype="multipart/form-data">
                <div>
        ...
        <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px; background-color: #fff;" id="post-1">
        ...
        <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px; background-color: #fff;" id="post-2">
            <div style="text-align: center; margin-bottom: 10px;">
        ...
        <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px; background-color: #fff;" id="post-3">
            <div style="text-align: center; margin-bottom: 10px;">
        ...
        <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px; background-color: #fff;" id="post-4">
            <div style="text-align: center; margin-bottom: 10px;">
