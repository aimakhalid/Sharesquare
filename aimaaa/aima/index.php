...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: beige;">
    <header style=" background-color: #C4A484; padding: 10px; color: #fff; text-align: center;">
        <div style="max-width: 960px; margin: 0 auto; padding: 20px;">
            ...
            <div style="text-align: left;">
                <a  style="color: #fff; text-decoration: none; margin-left: 10px;" href="login.php">Login</a>
                <a  style="color: #fff; text-decoration: none; margin-left: 10px;" href="register.php">Register</a>
            </div>
        </div>
    </header>
    ...
    <div style="max-width: 960px; margin: 0 auto; padding: 20px;">
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); grid-gap: 20px;">
            ...
            <div style=" margin-bottom: 20px; border: 1px solid #ccc; padding: 10px;" id="post-4">
                <div style="text-align: center; margin-bottom: 10px;">
